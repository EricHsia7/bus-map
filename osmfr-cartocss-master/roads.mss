...
#highway-area-casing [zoom >= 14] {
  [highway =~ '(residential|unclassified|yes)'] {
    line-color: #999;
    line-width: 1;
    line-cap: round;
    line-join: round;
...
#highway-junctions [zoom >= 11] {
  ref/text-name: "[ref]";
  ref/text-size: 10;
  ref/text-fill: #5555ff;
  ref/text-face-name: @book-fonts;
  ref/text-halo-radius: 1.25;
  ref/text-wrap-width: 12;
  ref/text-dy: 2;
  [zoom >= 13] {
    name/text-name: "[nom]";
    name/text-size: 9;
    name/text-fill: #5555ff;
    name/text-dy: -2;
    name/text-face-name: @book-fonts;
    name/text-halo-radius: 1.25;
...
#minor-roads-casing [zoom >= 12] { // noregexp
  ...
  [highway = 'trunk'] {
    ...
    [zoom >= 13] { line-width: 7.5; }
    [zoom >= 15] { line-width: 11.5; }
    [zoom >= 16][junction = 'roundabout'] { line-clip: false; line-smooth: 0.7; }
    [zoom >= 17] { line-width: 16; line-clip: false; line-smooth: 0.7; }
    [zoom >= 19] { line-width: 32; }
  }
...
#minor-roads-fill [zoom >= 11] { // noregexp
  ...
  [highway = 'motorway_link'][junction = 'roundabout'],
  [highway = 'motorway'] {
    line-width: 2.5;
    line-color: @motorway_color;
    line-clip: false;
  ...
  [highway = 'trunk_link'][junction = 'roundabout'],
  [highway = 'trunk'] {
    line-width: 2.5;
    line-cap: round;
    line-join: round;
  ...
  [highway = 'primary_link'][junction = 'roundabout'],
  [highway = 'primary'] {
    line-width: 2.5;
    line-color: #ec989a;
    line-join: round;
  ...
  [highway = 'secondary_link'][junction = 'roundabout'],
  [highway = 'secondary'] {
    line-width: 1.5;
  ...
  [highway = 'tertiary_link'][junction = 'roundabout'],
  [highway = 'tertiary'] {
    line-width: 1;
    line-color: #bbb;
    line-join: round;
  ...
  [highway = 'living_street'][zoom >= 13]{
    ...
    line-join: round;
    line-cap: round;
    [zoom >= 14] { line-width: 3; line-color: white; }
  ...
  [highway = 'steps'][zoom >= 13][zoom < 15][level>=0] {
    line-width: 6;
    line-color: #fff;
    line-opacity: 0.4;
    b/line-width: 2;
...
#minor-roads-fill-tunnels [zoom >= 12] { // noregexp
  ...
  ::highway {
    ...
    [highway = 'steps'][zoom >= 13][location != 'underground'] {
      line-width: 6;
      line-color: #fff;
      line-opacity: 0.4;
      b/line-width: 2;
...
#roads-text-name-lz,
#roads-text-name {
  ::highway [railway = ''][highway != 'rest_area'][highway != 'services'] {
    text-clip: true;
    text-avoid-edges: true;
    text-min-padding: 10;
    text-name: "";
  ...
  ::railway [railway != ''] {
    ...
    [zoom >= 15] {
      ...
      [zoom < 17][railway='platform'],
      [zoom<17][way_len < 1000],  /* pas d'affichage des nom des petites voies ferrées comme les quais avant le zoom 17 */
      [railway='platform'][tunnel!=""] {
        text-name: "";
      }
    }
  }
