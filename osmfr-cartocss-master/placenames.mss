...
.placenames-sea::land [place =~ '(island|archipelago|isthmus|islet)'][pixels>4]  {
  text-name: "[name]";
  text-size: 8;
  text-face-name: @oblique-fonts;
  text-halo-radius: 1;
...
.placenames-sea::water [place =~ 'ocean|sea|bay|strait'] {
  [pixels > 100], [pixels = 0] {
    text-name: "[name]";
    text-fill: #068;
    text-face-name: @oblique-fonts;
